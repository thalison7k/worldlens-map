...
export function MapToolbar() {
  ...
  return (
    <>
      ...
      <div
        className="pointer-events-none fixed left-14 z-30 flex max-w-[calc(100vw-4.5rem)] flex-wrap items-center gap-1 duration-500 animate-in fade-in slide-in-from-bottom-2 sm:left-16"
