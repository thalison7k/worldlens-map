...
export function Sidebar() {
  return (
    <aside className="pointer-events-auto fixed left-0 top-0 z-40 hidden h-full w-12 flex-col items-center gap-2 border-r border-white/10 bg-[color:var(--geoos-surface)]/70 py-3 backdrop-blur-xl sm:flex">
