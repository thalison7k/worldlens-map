...
const TemporalApp = lazy(() => import("./TemporalApp"));
...
export const APPS: GeoApp[] = [
  ...
  { id: "temporal", name: "Temporal Engine", description: "Timeline mundial com animação temporal.", icon: Sparkles, category: "intel", color: "45 90% 60%", defaultSize: { width: 720, height: 360 }, singleton: true, component: TemporalApp },
